...
c ... -mdh 9/21/2018
      do 214 ii = 1, MAXIEL
        read(7,*) dleave(ii), name
        call ckdata('sitein_ext','dleave',name)
214   continue
      do 215 ii = 1, MAXIEL
        read(7,*) dfbrche(ii), name
        call ckdata('sitein_ext','dfbrche',name)
215   continue
      do 216 ii = 1, MAXIEL
        read(7,*) dlwode(ii), name
        call ckdata('sitein_ext','dlwode',name)
216   continue
