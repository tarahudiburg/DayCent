...
c ... psloss is the rate of soil loss (kg/m**2/m) per day -mdh 1/97
...
c ...   matter and below ground litter for the day
...
c ... vek 08/91
     ...
     &            esrsnk)
      call soilos(time,nelem,2,flost,som2c(SOIL),som2ci,csrsnk,som2e,
     &            esrsnk)
