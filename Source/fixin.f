...
c ... to secondary P, cak - 03/20/02
      read(8,*) psecoc1, name
      call ckdata('fixin','psecoc1',name)
      read(8,*) psecoc2, name
      call ckdata('fixin','psecoc2',name)
...
c     write(*,*) 'fixin: '
c     write(*,*) 'teff(*) =', teff(1), teff(2), teff(3), teff(4)
      ...
      do 320 ii = 1, MAXIEL
        do 310 jj = 1,3
          read(8,*) varat11(jj,ii), name
          call ckdata('fixin','varat11',name)
310     continue
320   continue
      do 325 ii = 1, MAXIEL
        do 315 jj = 1,3
          read(8,*) varat12(jj,ii), name
          call ckdata('fixin','varat12',name)
315     continue
325   continue
      ...
      do 340 ii = 1, MAXIEL
        do 330 jj = 1,3
          ...
          call ckdata('fixin','varat21',name)
330     continue
340   continue
      do 345 ii = 1, MAXIEL
        do 335 jj = 1,3
          read(8,*) varat22(jj,ii), name
          call ckdata('fixin','varat22',name)
335     continue
345   continue
