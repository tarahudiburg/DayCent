...
**    CO2resp   - Heterotrophic CO2 respiration for the day (gCO2-C/ha/day)
**    curday    - the day of the year (1..366)
**    N2Oflux   - Nitrous oxide flux (gN2O-N/haday)
**    nit_amt   - Gross nitrification (gN/ha/day)
**    NOflux    - Nitric oxide flux (gN/ha/day)
**    ntCO2resp - "No-till" heterotrophic CO2 respiration removing cultivation
**                effects (gCO2-C/ha/day)
**    ppt       - Precipitation for day (cm/day)
