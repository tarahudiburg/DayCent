...
c ... Update monthly production output variables for grass/crop and
c ... forest systems. The code to do this has been moved to new mthprod 
c ... subroutine. -mdh 9/13/2018
      call mthprod(month)
