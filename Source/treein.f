...
c ..... Added water stress equation coefficents, cak - 07/10/2012
        ...
        call ckdata('treein', 'wscoef', name)
...
c ..... Added sfavail(2) (favail(1) moved from fix.100), cak - 01/06/2013
        ...
        call ckdata('treein','sfavai',name)
