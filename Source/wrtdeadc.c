...
**    dleavc    - carbon in attached dead leaf biomass (g C m-2)
**    dfbrchc   - carbon in attached dead fine branch biomass (g C m-2)
**    dlwodc    - carbon in attached dead standing large wood biomass (g C m-2)
**
**  GLOBAL VARIABLES:
**    None
**
...
#include "soilwater.h"
    ...
    void wrtdeadc(float *time, int *curday, float *stdedc, float *metabc1,
