...
c ... annual aboveground NPP calculated above, cak - 01/08/2010
     ...
     &      cmrspnpp(3) * agnpp) then
          mrspReduce =
     &      line(carbostg(CRPSYS,UNLABL)+carbostg(CRPSYS,LABELD),
     &           cmrspnpp(1) * agnpp, cmrspnpp(2),
     &           cmrspnpp(3) * agnpp, cmrspnpp(4))
        elseif (carbostg(CRPSYS,UNLABL)+carbostg(CRPSYS,LABELD) .gt.
     &          cmrspnpp(5) * agnpp) then
