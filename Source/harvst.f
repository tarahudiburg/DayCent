...
c     On a grain or root harvest event when above-ground live carbon
c     or below-ground live carbon values are 0, set the labeled fraction'
c     passed to partit to the labeled fraction of the current crop/grass,
c     cisfr, instead of 0.0.  -cak 05/08/2014
