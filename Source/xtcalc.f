...
c                       All Rights Reserved
      ...
      real function tcalc(avgstemp, teff)

      implicit none

c ... Argument declarations
      real avgstemp, teff(4)
...
c     write(*,*) 'tcalc: avgstemp=', avgstemp
c     write(*,*) 'teff(*) =', teff(1),teff(2),teff(3),teff(4)
      tcalc = max(0.01,
     &           carctanf(avgstemp,teff(1),teff(2),teff(3),teff(4))/
     &           normalizer)
