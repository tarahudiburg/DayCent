...
**                     pool to fast surface organic matter pool (gC/m^2/yr)
...
**                     root pool to fast soil organic matter pool (gC/m^2/yr)
**    awood3tosom22  - annual accumulator for carbon flow from dead coarse
**                     root pool to intermediate soil organic matter pool
**                     (gC/m^2/yr)
**    adwood1tosom11 - annual accumulator for carbon flow from dead attached
**                     fine branch pool to fast surface organic matter pool
**                     (gC/m^2/yr)
**    adwood1tosom21 - annual accumulator for carbon flow from dead attached 
**                     fine branch pool to intermediate surface organic matter
**                     pool (gC/m^2/yr)
**    adwood2tosom11 - annual accumulator for carbon flow from standing dead large wood
**                     pool to fast surface organic matter pool (gC/m^2)
**    adwood2tosom21 - annual accumulator for carbon flow from standing dead large wood
**                     pool to intermediate surface organic matter pool
**                     (gC/m^2/yr)
...
#include "soilwater.h"
                     ...
                     float *adwood2tosom11, float *adwood2tosom21)
    {
      ...
      fprintf(files->fp_yrcflows, "%12.6f  ", *adwood1tosom11);
      fprintf(files->fp_yrcflows, "%12.6f  ", *adwood1tosom21);
      fprintf(files->fp_yrcflows, "%12.6f  ", *adwood2tosom11);
      fprintf(files->fp_yrcflows, "%12.6f  ", *adwood2tosom21);
