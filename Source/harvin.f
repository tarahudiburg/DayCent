...
25      continue
        ...
        read(11, *) aglrem, name
        call ckdata('harvin','aglrem',name)
        read(11, *) bglrem, name 
        call ckdata('harvin','bglrem',name)
        read(11, *) temp, name
        flghrv = int(temp)
        call ckdata('harvin','flghrv',name)
...
c ..... cak - 10/02/00
        ...
        read(11, *) rmvstr, name 
        call ckdata('harvin','rmvstr',name)
        read(11, *) remwsd, name 
        call ckdata('harvin','remwsd',name)
        read(11, *) hibg, name 
        call ckdata('harvin','hibg',name)
        close(11)
        curharv = tomatch 
      endif
