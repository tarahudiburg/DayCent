...
c ... Fortran to C prototype
     ...
     &             wood1c, wood2c, wood3c, dleavc, dfbrchc, dlwodc)
...
c        voleac = voleac+volex
     ...
     &                  dwd1c2(UNLABL) + dwd1c2(LABELD) +
     &                  dwd2c2(UNLABL) + dwd2c2(LABELD)) - CO2resp)
     ...
     &              wd2c2(LABELD) + wd3c2(UNLABL) + wd3c2(LABELD) +
     &              dwd1c2(UNLABL) + dwd1c2(LABELD) +
     &              dwd2c2(UNLABL) + dwd2c2(LABELD) +
     &              st1uvc2(UNLABL) + st1uvc2(LABELD) +
     &              stduvc2(UNLABL) + stduvc2(LABELD) +
     &              wstduvc2(UNLABL) + wstduvc2(LABELD)
...
c ... Annual co2 accumulators (10/92)
      ...
      awstduvc2 = awstduvc2 + wstduvc2(UNLABL) + wstduvc2(LABELD)
